...
(function() {
    ...
    var v = /\s+/, q = function(a, b, c, d) {
        ...
        switch (b.length) {
                ...
                if (a = g[j], d = this._events[a]) {
                    ...
                    if (b ||
                        ...
                        for (h = d.length; k < h; k++)
                            e = d[k], (b && b !== e.callback && b !== e.callback._callback || c && c !== e.context) && t.push(e)
                    }
                    this._events[a] = t
                }
            return this
            ...
            if (d) {
                if (a)
                    a.off(b, "object" === typeof b ? this : c, this), !b && !c && delete d[a._listenerId];
                else {
    ...
    f.extend(r.prototype, h, {changed: null, idAttribute: "id", initialize: function() {
            ...
            for (d in e)
                b = e[d], f.isEqual(k[d], b) || a.push(d), f.isEqual(l[d], b) ? delete this.changed[d] : this.changed[d] = b, g ? delete k[d] : k[d] = b;
            if (!p) {
            ...
            if (this.isNew())
                return a.success(this, null, a), !1;
    ...
    f.extend(s.prototype, h, {model: r, initialize: function() {
            ...
            for (d = a.length; c < d; c++)
                (e = this._prepareModel(g = a[c], b)) ? (p = this.get(e)) ? b.merge && (p.set(g ===
            ...
            for (d = a.length; c < d; c++)
                if (g = this.get(a[c]))
                    delete this._byId[g.id], delete this._byId[g.cid], e = this.indexOf(g), this.models.splice(e, 1), this.length--, b.silent || (b.index = e, g.trigger("remove", g, this, b)), this._removeReference(g);
            return this
        }, push: function(a, b) {
            ...
            if (null != a)
                return this._idAttr || (this._idAttr = this.model.prototype.idAttribute), this._byId[a.id || a.cid || a[this._idAttr] || a]
        }, at: function(a) {
            ...
            if (b.remove) {
                ...
                for (e = this.models.length; d < e; d++)
                    c = this.models[d], l[c.cid] || j.push(c)
            }
