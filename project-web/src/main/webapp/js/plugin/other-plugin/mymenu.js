$(function() {
    ...
    $("#_feuil_rea").unbind("click");
    $("#_feuil_rea").bind("click", function(e) {
        ...
        else
        {
            ...
            $("#content").empty();
            $("#content").append('<iframe id="iframe" src="../body_page/rea.jsp" width="100%" height="1500" frameborder="0" style="display:none" onload="this.style.display = \'block\';"/>');
    ...
    $("#_formation").unbind("click");
    $("#_formation").bind("click", function(e) 
    {   
        var modifAnesthesie = localStorage.getItem("modifAnesthesie");
        if(modifAnesthesie === "true")
            valider_feuille_anesthesie(this);
        else
        {
            ...
            else
            {
                ...
                $(".breadcrumb").html($(this).attr("title"));
                $("#content").empty();
                $("#content").append('<iframe id="iframe_cloturee" src="../body_page/formation.jsp" width="100%" height="3000" frameborder="0" style="display:none" onload="this.style.display = \'block\';"/>');
    ...
    {   
        ...
        else
        {
            ...
            else
            {
                ...
                $(".breadcrumb").html($(this).attr("title"));
                $("#content").empty();
                $("#content").append('<iframe id="iframe_cloturee" src="../body_page/liste_patients.jsp" width="100%" height="3000" frameborder="0" style="display:none" onload="this.style.display = \'block\';"/>');
